...
.bb-timeline ul li .bb-cont ul li {
  margin-bottom: 0;
}
.bb-timeline .bb-item,
.bb-load button {
...
.bb-timeline .bb-info a {
  text-decoration: none;
}
.bb-timeline .datatime {
  font-size: 14px;
  color: pink;
}
.bb-timeline .bb-cont {
...
.bb-timeline .datacount svg {
  margin: 2px 5px;
}
.bb-timeline .bb-cont img[src*='emotion'] {
...
.rating-star {
  ...
  width: 75px;
  height: 15px;
  background-image: url('data:image/png;background-repeat:no-repeat;    base64,');
  overflow: hidden;
}
.allstar10 {
...
.dark .bb-timeline .bb-load button,
.dark .bb-timeline .bb-item {
  border: 1px solid #3b3d42;
}
.dark .bb-timeline .bb-item p {
  color: #fafafa;
}
.dark .bb-timeline .bb-item p svg {
  fill: #fafafa;
}
.dark #tag-list .tag-span {
...
function getMemoOne(memoOne) {
  ...
  let ContDom =
    document.querySelector('.content') || document.querySelector(bbMemo.domId);
...
function meNums(apiV1) {
  ...
  let bbUrl =
    memos + 'api/' + apiV1 + 'memo/stats?creatorId=' + bbMemo.creatorId;
  fetch(bbUrl)
    .then((res) => res.json())
    .then((resdata) => {
      let arrData = resdata || '';
      ...
      if (arrData) {
        let allnums = `<div id="bb-footer"><p class="bb-allnums">共 ${arrData.length} 条 </p><p class="bb-allpub"><a href="https://memos.clearsky.me/" target="_blank">揾嘢</a></p></div>`;
  ...
  fetch(randomUrl1)
    ...
    .then((resdata) => {
      ...
      let randomUrl2 =
        ...
        'memo?creatorId=' +
        bbMemo.creatorId +
        '&rowStatus=NORMAL&limit=1&offset=' +
        randomNum;
...
function setOpenID() {
  ...
  if (memosOpenIdSet !== null)
    window.localStorage &&
      window.localStorage.setItem('memos-access-token', memosOpenIdSet);
}
...
function archiveMemo(e) {
  ...
  if (memosOpenIdNow && memosOpenIdNow !== 'undefined' && memoId) {
    ...
    if (isOk) {
      let memoUrl =
        memos + 'api/' + apiV1 + 'memo/' + memoId + '?openId=' + memosOpenIdNow;
...
function loadTwikoo(e) {
  ...
  if (twikooDom.classList.contains('d-none')) {
    document.querySelectorAll('.item-twikoo').forEach((item) => {
    ...
    if (!document.getElementById('twikoo')) {
      ...
      let memoOne =
        location.pathname + '?memo=' + bbMemos.memos + 'm/' + memoId;
      history.pushState(
        { memoOne: memoOne, title: document.title },
        document.title,
        memoOne
      );
    }
...
function loadArtalk(e) {
  ...
  if (!ArtalkDom_ID) {
    ArtalkDom.insertAdjacentHTML(
      'afterbegin',
      '<div id="artalk-' + memoId + '"></div>'
    );
  }
  if (ArtalkDom.classList.contains('d-none')) {
    document.querySelectorAll('.item-artalk').forEach((item) => {
      item.classList.add('d-none');
    });
